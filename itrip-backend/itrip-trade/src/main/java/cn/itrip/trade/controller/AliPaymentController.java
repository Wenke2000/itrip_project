...
public class AliPaymentController {
			...
			if (verify_result) {// 验证成功
				...
				if (trade_status.equals("TRADE_FINISHED")) {
					...
					if(!orderService.processed(out_trade_no))
					{
						...
						orderService.paySuccess(out_trade_no, 1,trade_no);//支付类型:1.支付宝  2.微信 3.....
					}
	...
	public void callback(HttpServletRequest request,
		...
		try {
			...
			boolean verify_result = AlipaySignature.rsaCheckV1(params, alipayConfig.getAlipayPublicKey(), alipayConfig.getCharset(), "RSA2");//验证签名
